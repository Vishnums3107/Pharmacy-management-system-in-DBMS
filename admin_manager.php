...
<body>
    <div id="header">
        <h1><img src="images/managerNew.png" class="img"> Pharmacy Management System</h1>
        <div class="user-info">
    ...
    <div id="main">
        <div id="tabbed_box" class="tabbed_box">  
            ...
            <div class="tabbed_area">  
                <ul class="tabs">  
                    <li><a href="#content_1" class="active">VIEW MANAGERS</a></li>  
                    <li><a href="#content_2">ADD MANAGER</a></li>  
                </ul>  
                ...
                <div id="content_1" class="content active">  
                    ...
                    while($row = mysqli_fetch_array($result)) {
                        ...
                        echo '<td><a href="update_manager.php?id='.$row['manager_id'].'"><img src="images/updateNew.png" alt="Update"/></a></td>';
                        echo '<td><a href="delete_manager.php?id='.$row['manager_id'].'"><img src="images/deleteNew.png" alt="Delete"/></a></td>';
                        echo "</tr>";
                    } 
                    echo "</table>";
                    ?> 
                ...
                <div id="content_2" class="content">  
                    <fieldset>
                        ...
                        <form name="form1" onsubmit="return validateForm();" action="admin_manager.php" method="post" class="insert">
                            ...
                            <p><input name="submit" type="submit" value="Add Manager"></p>
                        </form>
                    </fieldset>
                </div>  
            </div>  
