...
<body>
    ...
    <div id="main">
        ...
        <p>Welcome back, <?php echo $user; ?>. Manage your pharmacy efficiently.</p>
        ...
        <div class="grid_7">
            ...
            <a href="admin_pharmacist.php" class="dashboard-module">
                <img src="images/pharmacistNew.png" alt="Pharmacist" />
                <span>Pharmacist</span>
            </a>
            <a href="admin_manager.php" class="dashboard-module">
                <img src="images/managerNew.png" alt="Manager" />
                <span>Manager</span>
            </a>
            <a href="admin_cashier.php" class="dashboard-module">
                <img src="images/cashierNew.png" alt="Cashier" />
                <span>Cashier</span>
            </a>
        </div>
    </div>
