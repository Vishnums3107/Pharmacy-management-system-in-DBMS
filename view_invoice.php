            ...
            <div class="card">
                ...
                <div class="tabbed_area">  
                    ...
                    <div id="content_1" class="content">  
                        ...
                        <?php
                        $result = mysqli_query($conn, "SELECT DISTINCT * FROM invoice") or die(mysqli_error());
                        echo "<table>";
                        echo "<thead><tr>
                                <th>Customer</th>
                                <th>Invoice No</th>
                        ...
                        while($row = mysqli_fetch_array($result)) {
                            ...
                            echo '<td>
                                    <a href="view_prescription_details.php?id='.$row['invoice_id'].'" class="action-btn" title="View Details">
